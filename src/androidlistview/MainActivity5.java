...
import com.androidhive.googleplacesandmaps.AlertDialogManager;
import com.androidhive.googleplacesandmaps.ConnectionDetector;
...
import com.androidhive.googleplacesandmaps.PlacesList;
import com.androidhive.googleplacesandmaps.R;
import com.androidhive.googleplacesandmaps.SettingActivity;
import com.androidhive.googleplacesandmaps.SinglePlaceActivity;
...
public class MainActivity5 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (!isInternetPresent) {
			...
			alert.showAlertDialog(MainActivity5.this, "Internet Connection Error",
		...
		int packagenumber=i.getIntExtra("packagenumber", 0);
 	    ...
 	    obj2=(sender) i.getSerializableExtra("object");
			...
			la = obj2.getG().getPlace(obj2.getG().getIndexToPid(obj2.getP().getPaths()[packagenumber][index])).getLat();
			lo = obj2.getG().getPlace(obj2.getG().getIndexToPid(obj2.getP().getPaths()[packagenumber][index])).getLon();
...
//		});
	 ...
	 @Override
	  public boolean onCreateOptionsMenu(Menu menu)
	  {
	      ...
	      menuInflater.inflate(R.menu.menu_activity_main2, menu);
	      return true;
	  }
	  ...
	  public boolean onOptionsItemSelected(MenuItem item)
	  {
	      ...
	      case R.id.menu_settings:
	    	  ...
	    	  Intent i=new Intent(MainActivity5.this,SettingActivity.class);
	    	  startActivity(i);
				...
				public void run() {
					...
					if(status.equals("OK")){
						...
						if (nearPlaces.results != null) {
							...
							// list adapter
							ListAdapter adapter = new SimpleAdapter(MainActivity5.this, placesListItems,
					                R.layout.list_item,
						...
						// Zero results found
						alert.showAlertDialog(MainActivity5.this, "Near Places",
								"Sorry no places found. Try to change the types of places",
								false);
					}
					else if(status.equals("UNKNOWN_ERROR"))
					{
						alert.showAlertDialog(MainActivity5.this, "Places Error",
